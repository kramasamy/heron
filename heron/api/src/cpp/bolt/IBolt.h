...
// TODO(Jordi): Include topology context
// #include "topology/topologycontext"
#include "types/Element.h"
#include "tuple/Tuple.h"

// TODO(Jordi): Does this comment make sense?
/**
...
class IBolt {
   ...
   */
  void prepare(std::unordered_map<std::string, Element> heronConf,
